...
class EditTodoViewModel extends ValueNotifier<EditTodoState> {
  EditTodoViewModel({
    ...
    required NotifyService notifyService,
       ...
       super(EditTodoState(initialTodo: initialTodo, isLoading: false));
  ...
  Future<void> onSubmitted() async {
    ...
    final todo = (value.initialTodo ?? Todo(title: '')).copyWith(
      title: value.title,
